...
$html1->outPageHead("", "" .
                        ...
                        "<script type=\"text/javascript\" src=\"../jslibs/some/parseTestResult.js?v=122015\"></script>\n");
...
<div id="pageArticleContent" class = "pageArticleContent">
    ...
    <div class = "pageArticleContent01">
        ...
        <input id="inputBatchID" type="text" name="foldername" size="16" style="display: none;"/>
        <!--p>Batch ID:&nbsp&nbsp&nbsp
           <input id="inputBatchID" type="text" name="foldername" size="16" 
            oninput="swtGetCardChoiceCodePerFrame('cardChoice', 'reportList', 'inputBatchID');" />
        </p-->
        ...
        <div id="" class="button01 roundCorner" onclick="swtGenerateRoutineReportPerFrame('finishPercentBar', 'reportList', 0, -1, -1);" onselectstart="return false;" style="float: left;">
        generate
        </div>
...
swtGetCardChoiceCodePerFrame("cardChoice", "reportList", "inputBatchID");
