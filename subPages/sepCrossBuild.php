...
<div id="pageArticleContent" class = "pageArticleContent">
    ...
    <div class = "pageArticleContent01">
        ...
        <div id="" class="button01 roundCorner" onclick="swtGenerateRoutineReport('finishPercentBar', 'reportList', 0, -1, 2);" onselectstart="return false;" style="float: left;">
        generate
        </div>
...
swtGetCardChoiceCodeCrossBuild("cardChoice", "reportList");
