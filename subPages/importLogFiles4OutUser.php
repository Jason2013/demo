...
<div id="pageArticleContent" class = "pageArticleContent">
    ...
    <div class = "pageArticleContent01">
        ...
        <div id="" class="button01 roundCorner" onclick="swtSubmitTestResultsMannualPerFrameOutUser('inputFolderName', 'finishPercentBar', 'inputUsername', 'inputPassword', 'selBatchID');" onselectstart="return false;" style="float: left;">
        import
        </div>
