                               ...
                               )
{
    $.post("../phplibs/createReport/swtGenTempFlatData.php", 
    {
        ...
        allFileListString:     _allFileListString,
        cardNameListString:    _cardNameListString,
        fileID:                _fileID,
        ...
        cardSysNameMachineIDDict: _cardSysNameMachineIDDict
    }, 
    function(data,status) 
    {
        //alert(data);
        ...
        if (json.errorCode == "1")
        {
            ...
            else
            {
                swtDoGenerateFlatData(_percentTagName,
                                      _machineIDList,
                                      _machineIDPair,
                                      json.cardSysNameMachineIDDict,
                                      _reportType,
                                      _batchID,
                                      json.allFileListString,
                                      json.cardNameListString,
                                      json.fileID,
                                      json.columnNum,
                                      json.rowNum,
                                      json.curReportFolder);
...
function swtXLSXBatchReport(_percentTagName, _batchID, _reportType, _fileID, _curReportFolder)
{
    ...
    function(data,status) 
    {
        ...
        if (json.errorCode == "1")
        {
            ...
            {
                // generate all history reports
                $("#" + _percentTagName).html("zipping XLSX to ZIP, please wait...");
