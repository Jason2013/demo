...
//include_once "swtClassGenReportPerFrame.php";
include_once "swtClassGenReportPerFrameTemplate.php";
...
//$colCardNameOrderList = array("Arielwav32_Win10 64 bit", "Arielwav64_Win10 64 bit");
//$colCardNameOrderIndexList = array(0, 0);

$t1 = cleanText($_POST["colCardNameOrderList"], 256);
$colCardNameOrderList = explode(",", $t1);
$t1 = cleanText($_POST["colCardNameOrderIndexList"], 256);
$colCardNameOrderIndexList = explode(",", $t1);
...
$returnSet = $xmlWriter->getColumnCardList($db, $batchID);
$returnMsg["returnLine"] = "line: " . __LINE__;
if ($returnSet === null)
{
    return;
}
$colCardSysNameList = $returnSet["colCardSysNameList"];
$colCardNameList = $returnSet["colCardNameList"];
$colSysNameList = $returnSet["colSysNameList"];
$colDriverNameList = $returnSet["colDriverNameList"];

$umdNameList = $colCardSysNameList;
$umdStandardOrder = $colCardSysNameList;
