...
class CGenReport
{
                ...
                for ($i = 0; $i < $reportUmdNum; $i++)
                {
                    ...
                    if ($isFirstColumn)
                    {
                        $tmpAverageDataCode = " <Cell ss:Index=\"" . 
                                              ($subjectNameFilterNumMax + 3 + ($dataColumnNum * 2) + 1 + 1 + ($graphDataColumnNum + 1) * 1 + $graphDataColumnNum * 2 + 2) . 
                                              "\" ss:StyleID=\"Default\"/>\n";
            ...
            for ($i = 0; $i < count($testNameList); $i++)
            {
                ...
                else
                {
                    ...
                    if ($i == 0)
                    {
                        ...
                        $t1 .= " <Cell ss:Index=\"" . 
                               ($subjectNameFilterNumMax + 3 + ($dataColumnNum * 2) + 1 + 1 + ($graphDataColumnNum + 1) * 1 + $graphDataColumnNum * 2 + 1) . 
                               "\" ss:StyleID=\"Default\"><Data ss:Type=\"String\">" .
                                           ...
                                           $_averageColumnHasVal)
	{
        ...
        //    //$graphDataColumnNum = intval($dataColumnNum / 3);
        //    //                        
        //    //$graphDataAreaNoBlank = "" . $swtSheetColumnIDList[$subjectNameFilterNumMax + 3 + ($dataColumnNum * 2) + 1 + ($graphDataColumnNum + 1) * 2 + 2 + 
        //    //                        $graphDataColumnNum * 2] .
        //    //                        $graphDataStartLineIDCompare . ":" . 
        //    //                        $swtSheetColumnIDList[$subjectNameFilterNumMax + 3 + ($dataColumnNum * 2) + 1 + ($graphDataColumnNum + 1) * 2 + 2 + 
