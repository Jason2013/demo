...
include_once "swtClassGenReportShaderBenchTemplate.php";
include_once "../configuration/swtConfig.php";


$xmlWriter = new CGenReport();
$xmlWriterTemplate = new CGenTemplteReport();
...
$userTemplatePath = substr($_POST["userTemplatePath"], 0, 256);
...
//$curTemplateFileName = "sb_report003.txt";
//$curTemplatePath = $userDefinedReportTemplateDir . "/" . $curTemplateFileName;

if (file_exists($userTemplatePath) == false)
{
    $returnMsg["errorCode"] = 0;
    $returnMsg["errorMsg"] = "invalid user template path, line: " . __LINE__;
...
$returnSet = $xmlWriterTemplate->preParseTemplate($userTemplatePath);
if ($returnSet === null)
{
    $returnMsg["errorCode"] = 0;
    $returnMsg["errorMsg"] = "user template format invalid, line: " . __LINE__;
    $returnMsg["returnLine"] = "line: " . __LINE__;
    echo json_encode($returnMsg);
    return;
}

//$returnSet = $xmlWriter->preParseUserDefinedReportTemplate($curTemplatePath);
//if ($returnSet === null)
//{
//    return;
//}
//// macros used in report template
//$templateMacroList = $returnSet["templateMacroList"];
//$userDefinedReportTemplate = $returnSet["userDefinedReportTemplate"];
//$templateCellStyleList = $returnSet["templateCellStyleList"];
...
$swtUmdNameList_sb = $xmlWriterTemplate->macroList["CompilerNameList"];
$swtUmdStandardOrder_sb = $xmlWriterTemplate->macroList["CompilerNameList"];
$swtUmdNameList_sb []= "OPT1";
$swtUmdStandardOrder_sb []= "OPT1";
...
$swtCardStandardOrder_sb = $xmlWriterTemplate->macroList["AsicNameList"];
$cardStandardOrder = $swtCardStandardOrder_sb;
...
// prepare the rest report template
//$xmlWriter->loadTemplateMacroList();
$xmlWriterTemplate->loadTemplateMacroList();
$xmlWriterTemplate->getStyleIDList();

$returnMsg["macroList"] = $xmlWriterTemplate->macroList;
$returnMsg["styleList"] = $xmlWriterTemplate->styleList;
$returnMsg["templateGraphSourceList"] = $xmlWriterTemplate->templateGraphSourceList;
