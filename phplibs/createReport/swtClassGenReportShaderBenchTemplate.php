...
include_once "swtClassUserTemplate.php";
...
class CGenReport
{
	...
	public function writeAdditionalStyles($_fileHandle)
	{
        ...
        $t1 = "";
        foreach($xmlWriterTemplate->styleList as $key => $val)
        {
            $isBold = isset($val["Bold"]) ? "ss:Bold=\"1\"" : "";
            $isNumber = isset($val["NumberFormat"]) ? "<NumberFormat ss:Format=\"" . $val["NumberFormat"] . "\"/>\n" : "";
            $bgColor = $val["BGColor"];
            $fontColor = $val["FontColor"];
            $horizonAlign = isset($val["HorizonAlign"]) ? $val["HorizonAlign"] : "Center";
            $isWrapText = isset($val["WrapText"]) ? "ss:WrapText=\"1\"" : "";
            
            $t1 .= "<Style ss:ID=\"s" . $n1 . "\">\n" .
                     "<Alignment ss:Horizontal=\"" . $horizonAlign . "\" ss:Vertical=\"Center\" " . $isWrapText . "/>\n" .
                     "<Borders>\n" .
                     "<Border ss:Position=\"Bottom\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\" ss:Color=\"#000000\"/>\n" .
                     "<Border ss:Position=\"Left\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\" ss:Color=\"#000000\"/>\n" .
                     "<Border ss:Position=\"Right\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\" ss:Color=\"#000000\"/>\n" .
                     "<Border ss:Position=\"Top\" ss:LineStyle=\"Continuous\" ss:Weight=\"1\" ss:Color=\"#000000\"/>\n" .
                     "</Borders>\n" .
                     "<Font ss:FontName=\"Calibri\" x:Family=\"Swiss\" ss:Size=\"11\" ss:Color=\"#" . $fontColor . "\" " . $isBold . "/>\n" .
                     "<Interior ss:Color=\"#" . $bgColor . "\" ss:Pattern=\"Solid\"/>\n" .
                     $isNumber .
                     "</Style>\n";
            $xmlWriterTemplate->styleList[$key]["styleID"] = $n1;
            $n1++;
    ...
    //public function preParseUserDefinedReportTemplate($_curTemplatePath)
    //{
    //    global $returnMsg;
    //    
    ...
    //        $tmpMacroList["AsicNum"] = count($tmpTemplate["Macro"]["AsicNum"]);
    //    }
    //    else
    //    {
    //        $returnMsg["errorCode"] = 0;
    ...
    //    //global $userDefinedReportTemplate;
    //    
    //    // #APIName
    //    $xmlWriterTemplate->macroList["APIName"] = $tmpUmd2Name;
    //    
    //    // #SysName
    //    $xmlWriterTemplate->macroList["SysName"] = $tmpSysName;
    //    
    //    // #TestName
    //    $xmlWriterTemplate->macroList["TestName"] = $testName;
    //    
    //    // #ChangeList, #ChangeList_Prev
    //    $xmlWriterTemplate->macroList["ChangeList"] = $swtReportInfo;
    //    $xmlWriterTemplate->macroList["ChangeList_Prev"] = $swtReportInfoPre;
    //    
    //    // #CellValue
    //    $xmlWriterTemplate->macroList["CellValue"] = false;
    //    
    //    // #ColumnID
    //    $xmlWriterTemplate->macroList["ColumnID"] = false;
    //    
    //    // #MachineResult_CompleTime,
    //    // #MachineResult_CompleTime_Prev
    //    // #MachineResult_ExecutionTime
    //    // #MachineResult_ExecutionTime_Prev
    //    $xmlWriterTemplate->macroList["MachineResult_CompleTime"] = false;
    //    $xmlWriterTemplate->macroList["MachineResult_CompleTime_Prev"] = false;
    //    $xmlWriterTemplate->macroList["MachineResult_ExecutionTime"] = false;
    //    $xmlWriterTemplate->macroList["MachineResult_ExecutionTime_Prev"] = false;
    //    
    //    // #RenderQuality
    //    $xmlWriterTemplate->macroList["RenderQuality"] = false;
    //    
    //    // #ResultUnit_ExecutionTime
    //    // #ResultUnit_CompileTime
    //    $tmpList = explode("|", $unitNameList[$curTestPos]);
    //    $xmlWriterTemplate->macroList["ResultUnit_ExecutionTime"] = $tmpList[1];
    //    $xmlWriterTemplate->macroList["ResultUnit_CompileTime"] = $tmpList[0];
    //    
    //    // #TestCaseID
    //    $xmlWriterTemplate->macroList["TestCaseID"] = 0;
    //    
    //    // #TestCaseParam
    //    $xmlWriterTemplate->macroList["TestCaseParam"] = "";
    //    
    //    // #TestCaseSelfID
    //    $xmlWriterTemplate->macroList["TestCaseSelfID"] = 0;
    //    
    //    $tmpTemplateHeaderName = "";
    //    $tmpTemplateBodyName = "";
    //    
    //    if (isset($xmlWriterTemplate->userTemplate["SheetList"]))
    //    {
    //        for ($i = 0; $i < count($xmlWriterTemplate->userTemplate["SheetList"]); $i++)
    //        {
    //            if ($xmlWriterTemplate->userTemplate["SheetList"][$i]["SheetType"] == "Customized")
    //            {
    //                $t1 = $xmlWriterTemplate->getTemplateText($xmlWriterTemplate->userTemplate["SheetList"][$i]["SheetName"]);
    //                
    //                if ($t1 == $tmpUmd2Name)
    //                {
    //                    // current template
    //                    $tmpTemplateHeaderName = $xmlWriterTemplate->userTemplate["SheetList"][$i]["HeaderStyle"];
    //                    $tmpTemplateBodyName = $xmlWriterTemplate->userTemplate["SheetList"][$i]["BodyStyle"];
    //                    
    //                    break;
    //                }
    //            }
    ...
    //        if (isset($xmlWriterTemplate->userTemplate[$tmpTemplateHeaderName]))
    //        {
    //            for ($i = 0; $i < count($xmlWriterTemplate->userTemplate[$tmpTemplateHeaderName]["Row0"]); $i++)
    //            {
    //                if (isset($xmlWriterTemplate->userTemplate[$tmpTemplateHeaderName]["Row0"][$i]["CellNum"]))
    //                {
    //                    $tmpRowCellNum += intval("" . $xmlWriterTemplate->getTemplateValue($xmlWriterTemplate->userTemplate[$tmpTemplateHeaderName]["Row0"][$i]["CellNum"]));
    //                }
    //                else
    //                {
    //                    $tmpRowCellNum++;
    ...
    //    }
    //    
    //    $xmlWriterTemplate->templateHeaderName = $tmpTemplateHeaderName;
    //    $xmlWriterTemplate->templateBodyName = $tmpTemplateBodyName;
    //    $xmlWriterTemplate->templateRowCellNum = $tmpRowCellNum;
    //    
    //    $returnSet = array();
    //    return $returnSet;
    //}
    ...
    //    {
    //        $macroKey = "";
    //        foreach ($templateMacroList as $key => $val)
    //        {
    //            $keyLen = strlen($key);
    ...
    //            {
    //                // array
    //                $t2 .= $templateMacroList[$macroKey][intval($tmpArrayIndex)];
    //                $n2 = $tmpPos2 + 1;
    //            }
    //            else
    //            {
    //                $t2 .= $templateMacroList[$macroKey];
                                              ...
                                              $_cmpCardName, $_cmpSysName)
	{
        ...
        if (file_exists($_xmlFileName) == false)
        {
            ...
            $t1 = $xmlWriterTemplate->getMainPageXMLCodeHeader();
            ...
            else
            {
                ...
                for ($i = 0; $i < $reportUmdNum; $i++)
                {
                    ...
                    if ($isFirstColumn)
                    {
                        ...
                        $tmpAverageDataCode = " <Cell ss:Index=\"" . 
                                              ($xmlWriterTemplate->templateRowCellNum + 3) . 
                                              "\" ss:StyleID=\"Default\"/>\n";
                            ...
                            ($graphDataColumnNum > 2))
                        {
                            ...
                            $tmpAverageDataCode = " <Cell ss:Index=\"" . 
                                                  ($xmlWriterTemplate->templateRowCellNum + 5) . 
                                                  "\" ss:StyleID=\"Default\"/>\n";
                        }
                ...
                else
                {
                    ...
                    for ($k = 0; $k < $reportUmdNum; $k++)
                    {
                        ...
                        else
                        {
                            ...
                            $tmpIndex1 = $xmlWriterTemplate->templateGraphSourceList[0][$tmpColumnNum] + 1;
                            $tmpIndex2 = $xmlWriterTemplate->templateGraphSourceList[1][$tmpColumnNum] + 1;
                                ...
                                ($graphDataColumnNum > 2))
                            {
                                ...
                                $tmpIndex1 = $xmlWriterTemplate->templateGraphSourceList[0][$tmpColumnNum] + 1;
                                $tmpIndex2 = $xmlWriterTemplate->templateGraphSourceList[1][$tmpColumnNum] + 2;
                            }
                    ...
                    if ($i == $startSubTestID)
                    {
                        ...
                        $tmpIndex = $xmlWriterTemplate->templateRowCellNum + 2;
                            ...
                            ($graphDataColumnNum > 2))
                        {
                            ...
                            $tmpIndex = $xmlWriterTemplate->templateRowCellNum + 4;
                        }
                    ...
                    else
                    {
                        ...
                        $tmpIndex = $xmlWriterTemplate->templateRowCellNum + 3;
                            ...
                            ($graphDataColumnNum > 2))
                        {
                            ...
                            $tmpIndex = $xmlWriterTemplate->templateRowCellNum + 5;
                        }
                                           ...
                                           $_averageColumnHasVal)
	{
        ...
        $graphDataArea = "" . $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1)] . 
                         $graphDataStartLineID . ":" . 
                         $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + $graphDataColumnNum - 1] .
                         (intval($graphDataStartLineID) + count($graphCells) - 1);
            ...
            ($graphDataColumnNum > 2))
        {
            ...
            $graphDataArea = "" . $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + 2] . 
                             $graphDataStartLineID . ":" . 
                             $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + 2 + $graphDataColumnNum - 1] .
                             (intval($graphDataStartLineID) + count($graphCells) - 1);
        }
        ...
        $graphDataAreaNoBlank = "" . $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + 2] . 
                         $graphDataStartLineID . ":" . 
                         $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + $graphDataColumnNum - 1] .
                         (intval($graphDataStartLineID) + count($graphCells) - 1);
            ...
            ($graphDataColumnNum > 2))
        {
            ...
            $graphDataAreaNoBlank = "" . $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + 2 + 2] . 
                             $graphDataStartLineID . ":" . 
                             $swtSheetColumnIDList[($xmlWriterTemplate->templateRowCellNum + 1) + 2 + $graphDataColumnNum - 1] .
                             (intval($graphDataStartLineID) + count($graphCells) - 1);
        }
        ...
        if ($_isCompStandard)
        {
            ...
            while ($row1 = $db->fetchRow())
            {
                ...
                $tmpMacroListRest = array();
                $tmpMacroListRest["TestCaseSelfID"] = $n1;
                $tmpMacroListRest["RenderQuality"] = array();
                ...
                for ($j = 0; $j < $umdNum; $j++)
                {
                    ...
                    if (strlen($umdData[$j]) > 0)
                    {
                        ...
                        $tmpMacroListRest["RenderQuality"] []= $t10;
                ...
                $tmpMacroListRest["TestCaseID"] = $standardTestCaseIDList[$n1];
                ...
                $tmpMacroListRest["TestCaseParam"] = $standardSubTestFilterNameList[$n1][0];
                $tmpMacroListRest["MachineResult_ExecutionTime"] = array();
                $tmpMacroListRest["MachineResult_ExecutionTime_Prev"] = array();
                $tmpMacroListRest["MachineResult_CompileTime"] = array();
                $tmpMacroListRest["MachineResult_CompileTime_Prev"] = array();
                
                $tmpMacroListRest["ColumnID"] = array();
                ...
                for ($i = 0; $i < $reportUmdNumn; $i++)
                {
                    ...
                    $tmpMacroListRest["MachineResult_ExecutionTime"] []= $tmpDataVal[$i];
                    $tmpMacroListRest["MachineResult_ExecutionTime_Prev"] []= $tmpDataVal[$reportUmdNumn * 2 + $i];
                    $tmpMacroListRest["MachineResult_CompileTime"] []= $tmpDataVal2[$i];
                    $tmpMacroListRest["MachineResult_CompileTime_Prev"] []= $tmpDataVal2[$reportUmdNumn * 2 + $i];
                ...
                else
                {
                    ...
                    for ($i = 0; $i < ($tmpDataColumnNum - 1); $i++)
                    {
                        ...
                        //$tmpMacroListRest["RenderQuality"] []= $tmpVerifyStatusList[$i];
                    }
                }
                
                // update template macros in real time
                $xmlWriterTemplate->loadTemplateMacroListRest($tmpMacroListRest);
                ...
                $t3 = $xmlWriterTemplate->getMainPageXMLCodeBody();
