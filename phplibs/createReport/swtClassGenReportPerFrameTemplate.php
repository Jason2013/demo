...
class CGenReport
{
	...
	public function getColumnCardList($_db, $_batchID)
	{
        ...
        $tmpCardSysNameList = $xmlWriterTemplate->macroList["AsicSystemNameList"];
	...
	public function getBatchInfo($_db, $_batchIDList)
	{
        ...
        foreach ($_batchIDList as $tmpBatchID)
        {
            ...
            while ($row1 = $db->fetchRow())
            {
                ...
                {
                    if (strtolower($tmpCardSysName) == strtolower($umdNameList[$i]))
                    {
                        $tmpIndex = $i;
                        break;
                    }
                                           ...
                                           $_averageColumnHasVal)
	{
        ...
        if ($_isCompStandard)
        {
            ...
            while ($row1 = $db->fetchRow())
            {
                ...
                $tmpMacroListRest["MachineResult_RecordTime"] = array();
                $tmpMacroListRest["MachineResult_RecordTime_Prev"] = array();
                ...
                for ($i = 0; $i < $reportUmdNumn; $i++)
                {
                    ...
                    $tmpMacroListRest["MachineResult_RecordTime"] []= $tmpDataVal2[$i];
                    $tmpMacroListRest["MachineResult_RecordTime_Prev"] []= $tmpDataVal2[$reportUmdNumn * 2 + $i];
